# This is a hack. It did solve the small usecase it was designed for,
# but YMMV.

# Usage: Include "behaviors/reverse-scroll.js".
# And add {behavior: 'reverse'} in the configuration hash.
# Ex: Check test/reverse.html
